...
LINE_ACCESS_TOKEN = "8yJIYtQJj0oGZfgP0UfGuXN2HY8wujjAaVq2EuaHx+ErdFwM1Txfw5U++zVwcq+9g6IUweN+1GwbYJZz89PEGO6PsyachN25bchpbwpQ517iEC+oHNfxfViw36I78zjzkX7W63c3sXZoRPkG7eAC/QdB04t89/1O/w1cDnyilFU="
GEMINI_API_KEY = "AIzaSyDpJtZPwtKvdAkHLK7k3bbRcEfEYNZ9K9A"
    ...
    def save_to_db(self):
        try:
            conn = pymysql.connect(
                host="JackHuracan.mysql.pythonanywhere-services.com",
                user="JackHuracan",
                password="0973490529Tawan",
                database="JackHuracan$default",
                charset="utf8mb4",
